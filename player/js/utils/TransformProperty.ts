...
const TransformPropertyFactory = (function () {
  ...
  function processKeys(this: any, forceRender: any) {
  ...
  function precalculateMatrix(this: any) {
  ...
  function TransformProperty(this: any, elem: any, data: any, container: any) {
    ...
    // Opacity is not part of the transform properties, that's why it won't use this.dynamicProperties.
    // That way transforms won't get updated if opacity changes.
    if (data.o) {
