...
function bezFunction() {
  ...
  function pointOnLine3D(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, x3: number, y3: number, z3: number): boolean {
    if (z1 === 0 && z2 === 0 && z3 === 0) {
  ...
  function getPointInSegment(pt1: NumberArray, pt2: NumberArray, pt3: NumberArray, pt4: NumberArray, percent: number, bezierData: BezierLengthData): [number, number] {
  ...
  function getNewSegment(pt1: NumberArray, pt2: NumberArray, pt3: NumberArray, pt4: NumberArray, startPerc: number, endPerc: number, bezierData: BezierLengthData): Float32Array {
    if (startPerc < 0) {
      startPerc = 0;
    } else if (startPerc > 1) {
      startPerc = 1;
