...
const builds = [
  ...
  {
    input: 'src/modules/svg_light.ts',
    dest: `${destinationBuildFolder}`,
  ...
  {
    input: 'src/modules/canvas.ts',
    dest: `${destinationBuildFolder}`,
    file: 'lottie_canvas.min.js',
    esm: true,
  },
  {
    input: 'src/modules/canvas_light.ts',
    dest: `${destinationBuildFolder}`,
  ...
  {
    input: 'src/modules/html_light.ts',
    dest: `${destinationBuildFolder}`,
