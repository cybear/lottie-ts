...
const TransformPropertyFactory = (function () {
  ...
  class TransformProperty extends DynamicPropertyContainer {
    ...
    propType: string;
    data: any;
    v: InstanceType<typeof Matrix>;
    pre: InstanceType<typeof Matrix>;
    ...
    constructor(elem: any, data: any, container: any) {
      super();
      this.elem = elem;
      this.frameId = -1;
    ...
    addDynamicProperty(prop: any) {
      super.addDynamicProperty(prop);
      this.elem.addDynamicProperty(prop);
      this._isDirty = true;
    }

    applyToMatrix(mat: any) {
